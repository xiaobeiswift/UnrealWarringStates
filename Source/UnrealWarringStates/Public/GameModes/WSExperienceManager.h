...
#include "WSExperienceManager.generated.h"

/**
 * 
 */
UCLASS()
class UNREALWARRINGSTATES_API UWSExperienceManager : public UEngineSubsystem
{
	GENERATED_BODY()
public:
#if WITH_EDITOR
	UNREALWARRINGSTATES_API void OnPlayInEditorBegun();
